# Generated by Powerlevel10k configuration wizard on 2024-01-14 at 02:58 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    distrobox               # to id a distrobox session
  ...
  function prompt_distrobox() {
      ...
      # customize symbol and color here
      p10k segment -f green -i 🛸 -t "Distrobox"
  }
